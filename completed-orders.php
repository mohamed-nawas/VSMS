            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                ...
                <div class="table-responsive table mt-2" id="dataTable" aria-describedby="dataTable_info">
                  <?php include 'includes/completed-orders-table.php' ?>
                  <?php require 'includes/completed-orders-table.php' ?>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?php if (!$row1orderno == ""): ?>
                          ...
                          <form action="includes/completed-orders-details.php" method="post">
                            <input type="hidden" name="order-id" value="<?php echo $row1orderid ?>">
                            <button class="btn btn-sm btn-primary" type="submit" name="row1-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row2orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row2-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row3orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row3-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row4orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row4-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row5orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row5-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row6orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row6-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row7orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row7-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row8orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row8-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row9orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row9-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td><?php if (!$row10orderno == ""): ?>
                          <form action="includes/completed-orders-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row10-details">Details</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                    </tbody>
