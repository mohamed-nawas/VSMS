        ...
        <div class="container-fluid">
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <p class="text-primary m-0 font-weight-bold">Request Form</p>
                </div>
                <div class="card-body">
                    <form action="includes/service-request-submit.php" method="post">
                      <div class="form-group">
                          <div class="row">
                              <div class="col text-center align-self-center"><label class="col-form-label">Vehicle Type</label></div>
                              <div class="col text-center align-self-center"><select class="custom-select custom-select-sm" name="vehicle-type" style="width: 514px;"><option value="2-Wheel" selected="">2-Wheel</option><option value="3-Wheel">3-Wheel</option><option value="3-Wheel-Auto">3-Wheel-Auto</option><option value="4-Wheel">4-Wheel</option>
                                <option value="4-Wheel-Tractor">4-Wheel-Tractor</option></select></div>
                          </div>
                          <div class="row">
                              <div class="col text-center align-self-center"><label class="col-form-label">Vehicle Name</label></div>
                              <div class="col text-center align-self-center"><input type="text" placeholder="vehicle name" name="vehicle-name" style="width: 514px;height: 31px;padding: 4px 28px 4px 8px;color: rgb(110,112,126);font-size: 14px;"></div>
                          </div>
                          <div class="row">
                              <div class="col text-center align-self-center"><label class="col-form-label">Vehicle Model</label></div>
                              <div class="col text-center align-self-center"><input type="text" placeholder="vehicle model" name="vehicle-model" style="width: 514px;height: 31px;padding: 4px 28px 4px 8px;color: rgb(110,112,126);font-size: 14px;"></div>
                          </div>
                          <div class="row">
                              <div class="col text-center align-self-center"><label class="col-form-label">Vehicle Brand</label></div>
                              <div class="col text-center align-self-center"><input type="text" placeholder="vehicle brand" name="vehicle-brand" style="width: 514px;height: 31px;padding: 4px 28px 4px 8px;color: rgb(110,112,126);font-size: 14px;"></div>
                          </div>
                          <div class="row">
                              <div class="col text-center align-self-center"><label class="col-form-label">Vehicle Registration No</label></div>
                              <div class="col text-center align-self-center"><input type="text" name="vehicle-regno" style="width: 514px;height: 31px;padding: 4px 28px 4px 8px;color: rgb(110,112,126);font-size: 14px;"></div>
                          </div>
                          <div class="row">
                              <div class="col text-center align-self-center"><label class="col-form-label">Service Date</label></div>
                              <div class="col text-center align-self-center"><input type="date" name="service-date" style="height: 31px;width: 514px;padding: 4px 28px 4px 8px;font-size: 14px;color: rgb(110,112,126);" required=""></div>
                          </div>
                          <div class="row">
                              <div class="col text-center align-self-center"><label class="col-form-label">Delivery Type</label></div>
                              <div class="col text-center align-self-center">
                                <select class="custom-select custom-select-sm" name="delivery-type" style="width: 514px;">
                                  <option value="pickup-service" selected="">pickup-service</option>
                          ...
                          <div class="row drop-service address">
                              ...
                              <div class="col text-center align-self-center"><input type="text" name="address" style="height: 31px;width: 514px;padding: 4px 28px 4px 8px;font-size: 14px;color: rgb(110,112,126);"></div>
                          </div>
                          <input type="hidden" name="request-email" value="<?php echo $mail ?>">
                          <div class="custom-control text-right custom-checkbox"><input class="custom-control-input" type="checkbox" name="license-check" id="formCheck-1"><label class="custom-control-label" for="formCheck-1">I accept terms and conditions</label></div><button class="btn btn-primary float-right" type="submit" name="service-request-submit" style="width: 90px;">Save</button></div>
