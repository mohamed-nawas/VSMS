          ...
          <div class="card shadow">
              ...
              <?php
                if (isset($_GET['details'])) {
                  if ($_GET['details'] == "parse") {
                    ...
                    $sql = "SELECT request_email, vehicle_type, vehicle_name, vehicle_model, vehicle_brand, vehicle_regno FROM services WHERE id=?";
                    $stmt = mysqli_stmt_init($conn);
                    if (!mysqli_stmt_prepare($stmt, $sql)) {
                      header("Location: ../completed-orders.php?error=sqlerror");
                      exit();
                    }
                    else {
                      ...
                      if ($row = mysqli_fetch_assoc($result)) {
                        $customermail = $row['request_email'];
              ...
              <div class="card-body">
                <div class="form-group">
                    <div class="row">
                        <div class="col text-center align-self-center"><label class="col-form-label">Customer Mail</label></div>
                        <div class="col text-center align-self-center"><label class="col-form-label"><?php echo $customermail ?></label></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                      <a class="btn btn-primary float-right" href="completed-orders.php" style="width: 80px; margin-left: 10px;">OK</a>
                    </div>
