      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Modify Staff</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Modify Mechanics</h6>
                </div>
                <div class="card-body">
                    ...
                    <table class="table align-items-center table-flush" id="dataTable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php if (!$row1id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              <input type="hidden" name="mechanic-id" value="<?php echo $row1id ?>">
                              <input type="hidden" name="mechanic-name" value="<?php echo $row1name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row1address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row1mobile ?>">
                              <button type="submit" name="row1-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row2id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row2name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row2address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row2mobile ?>">
                              <button type="submit" name="row2-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row3id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row3name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row3address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row3mobile ?>">
                              <button type="submit" name="row3-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row4id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row4name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row4address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row4mobile ?>">
                              <button type="submit" name="row4-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row5id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row5name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row5address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row5mobile ?>">
                              <button type="submit" name="row5-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row6id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row6name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row6address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row6mobile ?>">
                              <button type="submit" name="row6-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row7id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row7name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row7address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row7mobile ?>">
                              <button type="submit" name="row7-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row8id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row8name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row8address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row8mobile ?>">
                              <button type="submit" name="row8-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row9id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row9name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row9address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row9mobile ?>">
                              <button type="submit" name="row9-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if (!$row10id == ""): ?>
                            <form action="includes/mechanic-details-edit.php" method="post">
                              ...
                              <input type="hidden" name="mechanic-name" value="<?php echo $row10name ?>">
                              <input type="hidden" name="mechanic-address" value="<?php echo $row10address ?>">
                              <input type="hidden" name="mechanic-mobile" value="<?php echo $row10mobile ?>">
                              <button type="submit" name="row10-modify" class="btn btn-sm btn-primary">Modify</button>
                            </form>
                          <?php endif; ?></td>
                        </tr>
                      </tbody>
