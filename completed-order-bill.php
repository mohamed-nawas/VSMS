            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                ...
                <div class="table-responsive table mt-2" id="dataTable" aria-describedby="dataTable_info">
                  <?php include 'includes/completed-order-bill-table.php' ?>
                  <?php require 'includes/completed-order-bill-table.php' ?>
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      <tr>
                        <td><?php echo $row1orderid ?></td>
                        <td><?php echo $row1customer ?></td>
                        <td><?php echo $row1deliverydate ?></td>
                        <td><?php if (!$row1orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row1orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            <input type="hidden" name="order-id" value="<?php echo $row1orderid ?>">
                            <button class="btn btn-sm btn-primary" type="submit" name="row1-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row2orderid ?></td>
                        <td><?php echo $row2customer ?></td>
                        <td><?php echo $row2deliverydate ?></td>
                        <td><?php if (!$row2orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row2orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row2-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row3orderid ?></td>
                        <td><?php echo $row3customer ?></td>
                        <td><?php echo $row3deliverydate ?></td>
                        <td><?php if (!$row3orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row3orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row3-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row4orderid ?></td>
                        <td><?php echo $row4customer ?></td>
                        <td><?php echo $row4deliverydate ?></td>
                        <td><?php if (!$row4orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row4orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row4-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row5orderid ?></td>
                        <td><?php echo $row5customer ?></td>
                        <td><?php echo $row5deliverydate ?></td>
                        <td><?php if (!$row5orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row5orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row5-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row6orderid ?></td>
                        <td><?php echo $row6customer ?></td>
                        <td><?php echo $row6deliverydate ?></td>
                        <td><?php if (!$row6orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row6orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row6-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row7orderid ?></td>
                        <td><?php echo $row7customer ?></td>
                        <td><?php echo $row7deliverydate ?></td>
                        <td><?php if (!$row7orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row7orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row7-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row8orderid ?></td>
                        <td><?php echo $row8customer ?></td>
                        <td><?php echo $row8deliverydate ?></td>
                        <td><?php if (!$row8orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row8orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row8-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row9orderid ?></td>
                        <td><?php echo $row9customer ?></td>
                        <td><?php echo $row9deliverydate ?></td>
                        <td><?php if (!$row9orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row9orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row9-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $row10orderid ?></td>
                        <td><?php echo $row10customer ?></td>
                        <td><?php echo $row10deliverydate ?></td>
                        <td><?php if (!$row10orderid == ""): ?>
                          <span class="badge badge-info">Completed</span>
                        <?php endif; ?></td>
                        <td><?php if (!$row10orderid == ""): ?>
                          <!-- <a href="#" class="btn btn-sm btn-primary">Detail</a> -->
                          <form action="includes/completed-order-bill-details.php" method="post">
                            ...
                            <button class="btn btn-sm btn-primary" type="submit" name="row10-bill-details">Billing</button>
                          </form>
                        <?php endif; ?></td>
                      </tr>
                    </tbody>
